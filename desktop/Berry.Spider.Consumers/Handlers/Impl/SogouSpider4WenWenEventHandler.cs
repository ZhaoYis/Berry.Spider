...
/// 搜狗：问问
/// </summary>
public sealed class SogouSpider4WenWenEventHandler(SogouSpider4WenWenProvider provider) : ISogouSpider4WenWenEventHandler, ICapSubscribe
{
    private SogouSpider4WenWenProvider Provider { get; } = provider;
