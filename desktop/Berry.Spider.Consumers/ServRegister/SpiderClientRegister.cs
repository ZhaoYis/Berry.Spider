...
public class SpiderClientRegister : ISpiderClientRegister
{
    ...
    public async Task RegisterAsync()
    {
        try
        {
            ...
            await _redisService.HSetAsync(AppGlobalConstants.SPIDER_APPLICATION_LIFETIME_KEY, clientId, JsonSerializer.Serialize(lifetime));
        }
        catch (Exception e)
        {
            Console.WriteLine(e);
    ...
    public async Task UnRegisterAsync()
    {
        try
        {
            ...
            {
                string json = await _redisService.HGetAsync<string>(AppGlobalConstants.SPIDER_APPLICATION_LIFETIME_KEY, app.ClientId);
                ...
                if (lifetime is { })
                {
                    ...
                    await _redisService.HSetAsync(AppGlobalConstants.SPIDER_APPLICATION_LIFETIME_KEY, app.ClientId, JsonSerializer.Serialize(lifetime));
                }
            }
        }
        catch (Exception e)
