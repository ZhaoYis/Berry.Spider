...
public class TxtFileToDbHostedService : IHostedService
{
    ...
    {
        _abpApplication = await AbpApplicationFactory.CreateAsync<JsonFileToDbModule>(options =>
        {
        ...
        //启动服务
        await _abpApplication.ServiceProvider.GetRequiredService<IJsonFileToDbAppService>().RunAsync();
    }
