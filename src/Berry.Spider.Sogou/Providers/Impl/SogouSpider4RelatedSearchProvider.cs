...
public class SogouSpider4RelatedSearchProvider : ISogouSpiderProvider
{
        ...
        try
        {
            ...
            await this.WebElementLoadProvider.InvokeAsync(
                ...
                async root =>
                {
                    ...
                    {
                        var eto = new SogouSpider4RelatedSearchEto { Keyword = request.Keyword, Title = request.Keyword };
