...
{
    public const string RoutingKeyString = "TouTiao.HighQualityQuestionExtNo1.Pull";
    public const string QueueNameString = "Berry.TouTiao.HighQualityQuestionExtNo1.Pull";
