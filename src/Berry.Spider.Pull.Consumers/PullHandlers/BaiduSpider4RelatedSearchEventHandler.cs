...
/// 百度：相关推荐
/// </summary>
public class BaiduSpider4RelatedSearchEventHandler : IDistributedEventHandler<BaiduSpider4RelatedSearchEto>,
    ITransientDependency
{
    ...
    public async Task HandleEventAsync(BaiduSpider4RelatedSearchEto eventData)
    {
        try
        {
            await this.BaiduSpiderAppService.HandleEventAsync<BaiduSpider4RelatedSearchEto>(eventData);
        }
