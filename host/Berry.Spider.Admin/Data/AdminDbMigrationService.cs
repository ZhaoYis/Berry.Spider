...
public class AdminDbMigrationService : ITransientDependency
{
    ...
    private readonly AdminEFCoreDbSchemaMigrator _dbSchemaMigrator;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public AdminDbMigrationService(
        IDataSeeder dataSeeder,
        AdminEFCoreDbSchemaMigrator dbSchemaMigrator,
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "Berry.Spider.Admin");
    }
